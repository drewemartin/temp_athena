...
class DORA_DOMA_PARTICIPATION_SPRING < Athena_Table
...
#+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
    ...
    def table
        if !@table_structure
            structure_hash = {
                "name"              => "dora_doma_participation_spring",
                "file_name"         => "dora_doma_participation_spring.csv",
                "file_location"     => "dora_doma_participation_spring",
                "source_address"    => nil,
                "source_type"       => nil,
                "download_times"    => nil,
                "trigger_events"    => nil,
    ...
    def set_fields(structure_hash)
        ...
        structure_hash["fields"] = Hash.new
            ...
            structure_hash["fields"]["doma_test_date"]  = {"data_type"=>"date", "file_field"=>"DOMABMS"} if field_order.push("doma_test_date")
