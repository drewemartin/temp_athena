...
class DEPARTMENT_EVALUATION_SUMMARY_SNAPSHOT < Athena_Table
...
#+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
    ...
    def by_department_id(department_id, snapshot_date = nil)
...
#+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
    ...
    def table
        if !@table_structure
            structure_hash = {
                "name"              => "department_evaluation_summary_snapshot",
                "file_name"         => "department_evaluation_summary_snapshot.csv",
                "file_location"     => "department_evaluation_summary_snapshot",
                "source_address"    => nil,
                "source_type"       => nil,
                "audit"             => nil
            }
