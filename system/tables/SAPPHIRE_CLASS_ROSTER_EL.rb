...
class SAPPHIRE_CLASS_ROSTER_EL < Athena_Table
...
#+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
    ...
    def after_load_sapphire_class_roster_el
        ...
        $tables.attach("DAILY_ATTENDANCE_LOG").log_completed($idate, "sapphire_class_roster_el")
    ...
    def table
        if !@table_structure
            structure_hash = {
                ...
                "name"              => "sapphire_class_roster_el",
                "file_name"         => "sapphire_class_roster_el.csv",
                "file_location"     => "sapphire_class_roster_el",
                "source_address"    => nil,
                "source_type"       => nil,
                "audit"             => nil
            }
