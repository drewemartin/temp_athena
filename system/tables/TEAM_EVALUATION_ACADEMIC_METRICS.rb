...
class TEAM_EVALUATION_ACADEMIC_METRICS < Athena_Table
...
#+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
    ...
    def table
        if !@table_structure
            structure_hash = {
                "name"              => "team_evaluation_academic_metrics",
                "file_name"         => "team_evaluation_academic_metrics.csv",
                "file_location"     => "team_evaluation_academic_metrics",
                "source_address"    => nil,
                "source_type"       => nil,
                "audit"             => true,
