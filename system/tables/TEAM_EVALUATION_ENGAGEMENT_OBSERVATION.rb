...
class TEAM_EVALUATION_ENGAGEMENT_OBSERVATION < Athena_Table
...
#+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
    ...
    def table
        if !@table_structure
            structure_hash = {
                "name"              => "team_evaluation_engagement_observation",
                "file_name"         => "team_evaluation_engagement_observation.csv",
                "file_location"     => "team_evaluation_engagement_observation",
                "source_address"    => nil,
                "source_type"       => nil,
                "audit"             => true,
