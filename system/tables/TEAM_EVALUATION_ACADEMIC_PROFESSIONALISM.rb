...
class TEAM_EVALUATION_ACADEMIC_PROFESSIONALISM < Athena_Table
...
#+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
    ...
    def table
        if !@table_structure
            structure_hash = {
                "name"              => "team_evaluation_academic_professionalism",
                "file_name"         => "team_evaluation_academic_professionalism.csv",
                "file_location"     => "team_evaluation_academic_professionalism",
                "source_address"    => nil,
                "source_type"       => nil,
                "audit"             => true,
