...
#+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
    ...
    def set_fields(structure_hash)
        ...
        structure_hash["fields"] = Hash.new
            ...
            structure_hash["fields"]["teacher_rid"                      ] = {"data_type"=>"text",               "file_field"=>"TEACHER_RID"                                             } if field_order.push("teacher_rid"                     )
            structure_hash["fields"]["credits"                          ] = {"data_type"=>"decimal(10,2)",      "file_field"=>"CREDITS"                                                 } if field_order.push("credits"                         )
            ...
            structure_hash["fields"]["teacher_id"                       ] = {"data_type"=>"text",               "file_field"=>"TEACHER_ID"                                              } if field_order.push("teacher_id"                      )
