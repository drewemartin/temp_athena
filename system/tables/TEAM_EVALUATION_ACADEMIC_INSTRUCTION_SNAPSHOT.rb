...
class TEAM_EVALUATION_ACADEMIC_INSTRUCTION_SNAPSHOT < Athena_Table
...
#+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
    ...
    def table
        if !@table_structure
            structure_hash = {
                "name"              => "team_evaluation_academic_instruction_snapshot",
                "file_name"         => "team_evaluation_academic_instruction_snapshot.csv",
                "file_location"     => "team_evaluation_academic_instruction_snapshot",
                "source_address"    => nil,
                "source_type"       => nil,
                "audit"             => nil,
