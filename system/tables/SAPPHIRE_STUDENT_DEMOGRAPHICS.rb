...
#+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
    ...
    def set_fields(structure_hash)
        ...
        structure_hash["fields"] = Hash.new
            ...
            structure_hash["fields"]["resident_district"] = {"data_type"=>"int",  "file_field"=>"RESIDENT_DISTRICT"     } if field_order.push("resident_district"       )
            structure_hash["fields"]["state_student_id" ] = {"data_type"=>"int",  "file_field"=>"STATE_STUDENT_ID"      } if field_order.push("state_student_id"        )
            structure_hash["fields"]["ethnicity_desc"   ] = {"data_type"=>"text", "file_field"=>"ETHNICITY_DESC"        } if field_order.push("ethnicity_desc"          )
            structure_hash["fields"]["ethnicity"        ] = {"data_type"=>"int",  "file_field"=>"ETHNICITY"             } if field_order.push("ethnicity"               )
