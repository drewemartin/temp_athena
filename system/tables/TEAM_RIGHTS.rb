...
#+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
    ...
    def set_fields(structure_hash)
        ...
        structure_hash["fields"] = Hash.new
            ...
            structure_hash["fields"]["live_reports_dnc_students"                                ] = {"data_type"=>"bool", "file_field"=>"live_reports_dnc_students"                             } if field_order.push("live_reports_dnc_students"                               )
            ...
            structure_hash["fields"]["live_reports_student_ilp_survey_completion"               ] = {"data_type"=>"bool", "file_field"=>"live_reports_student_ilp_survey_completion"            } if field_order.push("live_reports_student_ilp_survey_completion"              )
            structure_hash["fields"]["live_reports_student_isp"                                 ] = {"data_type"=>"bool", "file_field"=>"live_reports_student_isp"                              } if field_order.push("live_reports_student_isp"                                )
            ...
            structure_hash["fields"]["live_reports_student_tep_agreements"                      ] = {"data_type"=>"bool", "file_field"=>"live_reports_student_tep_agreements"                   } if field_order.push("live_reports_student_tep_agreements"                     )
            ...
            structure_hash["fields"]["live_reports_team_member_testing_events_attendance"       ] = {"data_type"=>"bool", "file_field"=>"live_reports_team_member_testing_events_attendance"    } if field_order.push("live_reports_team_member_testing_events_attendance"      )
            structure_hash["fields"]["live_reports_unverified_previous_school"                  ] = {"data_type"=>"bool", "file_field"=>"live_reports_unverified_previous_school"               } if field_order.push("live_reports_unverified_previous_school"                 )
            structure_hash["fields"]["live_reports_rri_requests_open_nursing"                   ] = {"data_type"=>"bool", "file_field"=>"live_reports_rri_requests_open_nursing"                } if field_order.push("live_reports_rri_requests_open_nursing"                  )
            structure_hash["fields"]["live_reports_rri_requests_open_transcripts"               ] = {"data_type"=>"bool", "file_field"=>"live_reports_rri_requests_open_transcripts"            } if field_order.push("live_reports_rri_requests_open_transcripts"              )
            structure_hash["fields"]["live_reports_rri_requests_open"                           ] = {"data_type"=>"bool", "file_field"=>"live_reports_rri_requests_open"                        } if field_order.push("live_reports_rri_requests_open"                          )
            structure_hash["fields"]["live_reports_rri_requests_open_all"                       ] = {"data_type"=>"bool", "file_field"=>"live_reports_rri_requests_open_all"                    } if field_order.push("live_reports_rri_requests_open_all"                      )
