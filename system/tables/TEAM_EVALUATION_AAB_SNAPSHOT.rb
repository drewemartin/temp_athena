...
class TEAM_EVALUATION_AAB_SNAPSHOT < Athena_Table
...
#+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
    ...
    def table
        if !@table_structure
            structure_hash = {
                "name"              => "team_evaluation_aab_snapshot",
                "file_name"         => "team_evaluation_aab_snapshot.csv",
                "file_location"     => "team_evaluation_aab_snapshot",
                "source_address"    => nil,
                "source_type"       => nil,
                "audit"             => nil,
