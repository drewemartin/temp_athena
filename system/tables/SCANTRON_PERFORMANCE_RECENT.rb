...
class SCANTRON_PERFORMANCE_RECENT < Athena_Table
...
#+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
    ...
    def table
        if !@table_structure
            structure_hash = {
                "name"              => "scantron_performance_recent",
                "file_name"         => "scantron_performance_recent.csv",
                "file_location"     => "scantron_performance_recent",
                "source_address"    => nil,
                "source_type"       => nil,
                "download_times"    => nil,
                "trigger_events"    => nil,
    ...
    def set_fields(structure_hash)
        ...
        structure_hash["fields"] = Hash.new
            ...
            structure_hash["fields"]["math_prediction_name_short"] = {"data_type"=>"int", "file_field"=>"Math_Prediction_Name_Short"} if field_order.push("math_prediction_name_short")
            structure_hash["fields"]["math_predicted_name_long"] = {"data_type"=>"int", "file_field"=>"Math_Predicted_Name_Long"} if field_order.push("math_predicted_name_long")
            ...
            structure_hash["fields"]["reading_prediction_name_short"] = {"data_type"=>"int", "file_field"=>"Reading_Prediction_Name_Short"} if field_order.push("reading_prediction_name_short")
            structure_hash["fields"]["reading_predicted_name_long"] = {"data_type"=>"int", "file_field"=>"Reading_Predicted_Name_Long"} if field_order.push("reading_predicted_name_long")
            ...
            structure_hash["fields"]["science_prediction_name_short"] = {"data_type"=>"int", "file_field"=>"Science_Prediction_Name_Short"} if field_order.push("science_prediction_name_short")
            structure_hash["fields"]["science_predicted_name_long"] = {"data_type"=>"int", "file_field"=>"Science_Predicted_Name_Long"} if field_order.push("science_predicted_name_long")
            ...
            structure_hash["fields"]["language_arts_prediction_name_short"] = {"data_type"=>"int", "file_field"=>"Language_Arts_Prediction_Name_Short"} if field_order.push("language_arts_prediction_name_short")
            structure_hash["fields"]["language_arts_predicted_name_long"] = {"data_type"=>"int", "file_field"=>"Language_Arts_Predicted_Name_Long"} if field_order.push("language_arts_predicted_name_long")
