...
class SAPPHIRE_CLASS_ROSTER_HS < Athena_Table
...
#+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
    ...
    def after_load_sapphire_class_roster_hs
        ...
        $tables.attach("DAILY_ATTENDANCE_LOG").log_completed($idate, "sapphire_class_roster_hs")
    ...
    def table
        if !@table_structure
            structure_hash = {
                ...
                "name"              => "sapphire_class_roster_hs",
                "file_name"         => "sapphire_class_roster_hs.csv",
                "file_location"     => "sapphire_class_roster_hs",
                "source_address"    => nil,
                "source_type"       => nil,
                "audit"             => nil
            }
