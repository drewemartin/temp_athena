...
class STUDENT_SPECIALIST_READING < Athena_Table
...
#+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
    ...
    def table
        if !@table_structure
            structure_hash = {
                "name"              => "student_specialist_reading",
                "file_name"         => "student_specialist_reading.csv",
                "file_location"     => "student_specialist_reading",
                "source_address"    => nil,
                "source_type"       => nil,
                "audit"             => true,
