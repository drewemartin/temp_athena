...
class TEAM_EVALUATION_ENGAGEMENT_METRICS < Athena_Table
...
#+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
    ...
    def after_change_field_attendance(field)
        
        update_score_field(field)
        
    end
    
    def after_change_field_evaluation_participation(field)
        
        update_score_field(field)
        
    end
    
    def after_change_field_feedback(field)
        
        update_score_field(field)
        
    end
    
    def after_change_field_quality_documentation(field)
        
        update_score_field(field)
        
    end

    def after_change_field_scantron_participation(field)
        
        update_score_field(field)
        
    end
    
    def after_change_field_truancy_prevention(field)
        
        update_score_field(field)
        
    end
    
    def update_score_field(field)
...
#+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
    ...
    def table
        if !@table_structure
            structure_hash = {
                "name"              => "team_evaluation_engagement_metrics",
                "file_name"         => "team_evaluation_engagement_metrics.csv",
                "file_location"     => "team_evaluation_engagement_metrics",
                "source_address"    => nil,
                "source_type"       => nil,
                "audit"             => true,
