...
class TEAM_EVALUATION_ENGAGEMENT_PROFESSIONALISM_SNAPSHOT < Athena_Table
...
#+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
    ...
    def table
        if !@table_structure
            structure_hash = {
                "name"              => "team_evaluation_engagement_professionalism_snapshot",
                "file_name"         => "team_evaluation_engagement_professionalism_snapshot.csv",
                "file_location"     => "team_evaluation_engagement_professionalism_snapshot",
                "source_address"    => nil,
                "source_type"       => nil,
                "audit"             => nil,
