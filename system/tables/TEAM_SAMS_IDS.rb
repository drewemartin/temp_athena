...
class TEAM_SAMS_IDS < Athena_Table
...
#+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
    ...
    def by_sams_id(sams_id, team_id = nil)
        
        params = Array.new
        params.push( Struct::WHERE_PARAMS.new("sams_id", "=", sams_id) )
...
#+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
    ...
    def table
        if !@table_structure
            structure_hash = {
                "name"              => "team_sams_ids",
                "file_name"         => "team_sams_ids.csv",
                "file_location"     => "team_sams_ids.csv",
                "source_address"    => nil,
                "source_type"       => nil,
                "audit"             => true,
