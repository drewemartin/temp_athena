...
#+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
    ...
    def click_withdraw_student
        link_id  = "e_0_17_1_1_3_1940662712_0_9_0_0_3_1_0_3_1_1_0_0_0_13_7_1_9_1"
        complete = false
        until complete
            if browser.link(:id, link_id).exists?
    ...
    def login
        if !structure["login"]
            ...
            until field_found
                if browser.text_field(:name, field).exists?
                    browser.text_field(:name, field).set "jensSuperSecretPW"
                    field_found = true
                end
            end
