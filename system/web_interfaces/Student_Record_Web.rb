...
#+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
    ...
    def menu_section
        ...
        output << $field.new("value"=>"Academic Plan"           ).web.button(:onclick=>"$('#page').val('Student_Attendance_AP_Web'              );send_unsaved();send_covered('sid');clear_student_record_content();",    :field_class=>field_class, :no_div=>true ) if $team_member.super_user? || $team_member.rights.module_student_attendance_ap.is_true?
        output << $field.new("value"=>"Assessments"             ).web.button(:onclick=>"$('#page').val('STUDENT_ASSESSMENTS_WEB'                );send_unsaved();send_covered('sid');clear_student_record_content();",    :field_class=>field_class, :no_div=>true ) if $team_member.super_user? || $team_member.rights.module_student_assessments.is_true?
        output << $field.new("value"=>"Attendance"              ).web.button(:onclick=>"$('#page').val('STUDENT_ATTENDANCE_WEB'                 );send_unsaved();send_covered('sid');clear_student_record_content();",    :field_class=>field_class, :no_div=>true ) if $team_member.super_user? || $team_member.rights.module_student_attendance.is_true?
        output << $field.new("value"=>"Individual Learning Plan").web.button(:onclick=>"$('#page').val('STUDENT_ILP_WEB'                        );send_unsaved();send_covered('sid');clear_student_record_content();",    :field_class=>field_class, :no_div=>true ) if $team_member.super_user? || $team_member.rights.module_student_ilp.is_true?
        output << $field.new("value"=>"Ink Orders"              ).web.button(:onclick=>"$('#page').val('INK_ORDERS_WEB'                         );send_unsaved();send_covered('sid');clear_student_record_content();",    :field_class=>field_class, :no_div=>true ) if $team_member.super_user? || $team_member.rights.module_ink_orders.is_true?
        output << $field.new("value"=>"No Call Requests"        ).web.button(:onclick=>"$('#page').val('DNC_STUDENTS_WEB'                       );send_unsaved();send_covered('sid');clear_student_record_content();",    :field_class=>field_class, :no_div=>true ) if $team_member.super_user? || $team_member.rights.module_dnc_students.is_true?
        output << $field.new("value"=>"Notes"                   ).web.button(:onclick=>"$('#page').val('Student_Contacts_Web'                   );send_unsaved();send_covered('sid');clear_student_record_content();",    :field_class=>field_class, :no_div=>true ) if $team_member.super_user? || $team_member.rights.module_student_contacts.is_true?
        output << $field.new("value"=>"Psychological Evaluation").web.button(:onclick=>"$('#page').val('STUDENT_PSYCHOLOGICAL_EVALUATION_WEB'   );send_unsaved();send_covered('sid');clear_student_record_content();",    :field_class=>field_class, :no_div=>true ) if $team_member.super_user? || $team_member.rights.module_student_psychological_evaluation.is_true?
        output << $field.new("value"=>"PSSA Records"            ).web.button(:onclick=>"$('#page').val('PSSA_ENTRY_WEB'                         );send_unsaved();send_covered('sid');clear_student_record_content();",    :field_class=>field_class, :no_div=>true ) if $team_member.super_user? || $team_member.rights.module_pssa_entry.is_true?
        output << $field.new("value"=>"Record Requests"         ).web.button(:onclick=>"$('#page').val('RECORD_REQUESTS_WEB'                    );send_unsaved();send_covered('sid');clear_student_record_content();",    :field_class=>field_class, :no_div=>true ) if $team_member.super_user? || $team_member.rights.module_record_requests.is_true?
        output << $field.new("value"=>"RTII Behavior"           ).web.button(:onclick=>"$('#page').val('Student_RTII_Web'                       );send_unsaved();send_covered('sid');clear_student_record_content();",    :field_class=>field_class, :no_div=>true ) if $team_member.super_user? || $team_member.rights.module_student_rtii.is_true?
        output << $field.new("value"=>"Specialists"             ).web.button(:onclick=>"$('#page').val('STUDENT_SPECIALISTS_WEB'                );send_unsaved();send_covered('sid');clear_student_record_content();",    :field_class=>field_class, :no_div=>true ) if $team_member.super_user? || $team_member.rights.module_student_specialists.is_true?
        output << $field.new("value"=>"TEP"                     ).web.button(:onclick=>"$('#page').val('Tep_Agreements_Web'                     );send_unsaved();send_covered('sid');clear_student_record_content();",    :field_class=>field_class, :no_div=>true ) if $team_member.super_user? || $team_member.rights.module_tep_agreements.is_true?
        output << $field.new("value"=>"Test Events"             ).web.button(:onclick=>"$('#page').val('STUDENT_TESTS_WEB'                      );send_unsaved();send_covered('sid');clear_student_record_content();",    :field_class=>field_class, :no_div=>true ) if $team_member.super_user? || $team_member.rights.module_student_tests.is_true?
        output << $field.new("value"=>"Withdraw Records"        ).web.button(:onclick=>"$('#page').val('WITHDRAW_REQUESTS_WEB'                  );send_unsaved();send_covered('sid');clear_student_record_content();",    :field_class=>field_class, :no_div=>true ) if $team_member.super_user? || $team_member.rights.module_withdraw_requests.is_true?
