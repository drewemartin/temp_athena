...
#+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
    ...
    def menu_section
        ...
        output << $field.new("value"=>"Notes"                   ).web.button(:onclick=>"$('#page').val('Student_Contacts_Web'                   );send_covered('sid');clear_student_record_content();",    :field_class=>field_class, :no_div=>true ) if $team_member.super_user? || $team_member.rights.module_student_contacts.is_true?
