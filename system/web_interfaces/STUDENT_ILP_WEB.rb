...
#+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
    ...
    def css
        ...
        output << "div.STUDENT_ILP__monday                                  {text-align: center;}"
        output << "div.STUDENT_ILP__tuesday                                 {text-align: center;}"
        output << "div.STUDENT_ILP__wednesday                               {text-align: center;}"
        output << "div.STUDENT_ILP__thursday                                {text-align: center;}"
        output << "div.STUDENT_ILP__friday                                  {text-align: center;}"
