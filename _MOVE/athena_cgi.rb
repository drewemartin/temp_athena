        ...
        if params[:new_csv]
            ...
            if web_script.respond_to?(function_str)
                ...
                if results
                    ...
                    file_path   = $reports.csv("temp", user_log_record.primary_id, results)
                    ...
                    #filecontent = $reports.csv("temp", user_log_record.primary_id, results, nil, true)
...
cgi     = CGI.new
params[:remote_address] = cgi.remote_addr 
cgi.keys.each{|key|
