...
<script>function student_page_view(){
		x=window.frames[0].document.getElementById("student_page_view").value
		window.frames[0].document.getElementById("student_page_view").value = kyss+"."+x
	}
</script>
...
<div id='loading_cover' style='position:fixed; top:0px; left:0px; margin-left:-32px; margin-top:-32px; z-index:999999;'></DIV>"
...
<script>var kyss = "<?php global $current_user;get_currentuserinfo();echo $current_user->ID;?>.<?php echo is_user_logged_in();?>.<?php the_ID() ?>";</script>
<?php arras_body() ?>
...
<div id="wrapper">
	...
	<div id='add_new_dialog' class='add_new_dialog'></div>
